...
use App\Http\Controllers\DiaDanhApiController;
...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    // sites
    Route::get('/sites',[DiaDanhApiController::class,'index']);
    Route::get('/sites/{id}',[DiaDanhApiController::class,'show']);

    //vung-mien
    Route::get('/vungmien',[VungMienController::class,'index']);
    Route::get('/vungmien/{id}',[VungMienController::class,'show']);
});